      ...
      <footer className="relative w-full">
         <div className="w-full h-[450px] relative">
            <iframe
               ...
               allowFullScreen
               loading="lazy"
               title="Sri Chaitanya School Location"
            />
            {/* Responsive Floating Card */}
            <div className="absolute left-1/2 lg:left-auto lg:right-12 top-1/2 -translate-x-1/2 lg:translate-x-0 -translate-y-1/2 bg-white px-5 md:px-8 py-6 md:py-10 shadow-[0_30px_100px_rgba(0,0,0,0.3)] w-[85%] md:w-auto md:max-w-sm text-center rounded-sm z-20 border border-gray-100 transition-all duration-300">
               ...
               <h3 className="text-lg md:text-xl font-black text-[#2C3E50] mb-3 md:mb-4 uppercase tracking-tight italic">Sri Chaitanya School</h3>
         ...
         <div className="bg-[#1B2631] py-10 px-12 flex flex-col md:flex-row justify-between items-center text-white text-[14px] font-black">
            ...
            <div className="mt-8 md:mt-0 opacity-50 uppercase tracking-[0.3em] text-[12px]">
               © Copyright Sri Chaitanya Schools - 2026
            </div>
         </div>
      </footer>
   );
